...
object InputOperations {
    ...
    @JvmStatic // Assumes a valid operation format.
    ...
    @JvmStatic // Assumes a valid operation.
    ...
    fun isDivisionByZero(operationStr: String): Boolean {
        ...
        val isWholeZero = elements[2].toIntOrNull() == 0
        val fractionParts = elements[2].split("/")
        val isProperZero = fractionParts.size == 2 && fractionParts[0] == "0"
        val improperFractionParts = elements[2].split("&")
        val isImproperZero = improperFractionParts.size == 2 && improperFractionParts[0] == "0" && improperFractionParts[1].split("/")[0] == "0"

        return isWholeZero || isProperZero || isImproperZero
    }
